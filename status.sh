...
#
while true; do uptime && vcgencmd measure_temp && vcgencmd measure_clock arm && vcgencmd get_throttled; free -t -m; /home/pi/GoPiLgc/plib/battery.py; sleep 2; echo ''; done
